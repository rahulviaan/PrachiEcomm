...
namespace ReadEdgeCore.Utilities
{
    public static class Common
    {
        ...
        public static int SendSMS(string mobileNumber, string message)
        {
            ...
            var Url = "https://www.kit19.com/ComposeSMS.aspx?username=prachi88225&password=73780&sender=PIPLIN&to=" + mobileNumber + "&message=" + message + "&priority=1&dnd=1&unicode=0&dlttemplateid=1707161588898793875";
            try
            {
            ...
            public static void SendMail(string ToEmail, string Subj, string Message)
            {
                MailMessage mailMessage = new MailMessage();
                mailMessage.From = new MailAddress("marketing@prachigroup.com", "no-reply@prachigroup.com");
                ...
                SmtpClient smtpClient = new SmtpClient
                {
                    ...
                    Credentials = new NetworkCredential("marketing@prachigroup.com", "otp@1212")
                };
                try
                {
