...
namespace PrachiIndia.Portal
{
    public class EmailService : IIdentityMessageService
    {
        public Task SendAsync(IdentityMessage message)
        {
            ...
            MailServiece.Mail.SendMail(MailFrom, message.Subject, message.Body);
            // Portal.Framework.Utility.SendMail(message.Subject, message.Body, message.Destination, MailFrom, null);
